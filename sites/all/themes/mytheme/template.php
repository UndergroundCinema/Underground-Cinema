...
function mytheme_breadcrumb($variables){
  ...
  $breadcrumb_separator=theme_get_setting('breadcrumb_separator','mytheme');
...
function mytheme_page_alter($page) {
	...
	if (theme_get_setting('responsive_meta','mytheme')):
...
function mytheme_preprocess_html(&$variables) {
	...
	if (!theme_get_setting('responsive_respond','mytheme')):
